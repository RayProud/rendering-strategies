...
RUN yarn;
RUN yarn workspace aws-self-hosted-15 build;
...
COPY --from=builder --chown=nextjs:nodejs /app/applications/aws-self-hosted-15/.next/static ./applications/aws-self-hosted-15/.next/static
